...
This section will define the problem(s)/challenges that the customer wants to address with a Cognitive Services solution. Include things like costs, customer experience, etc.
...
- Architecture diagram/s (**required**). Example below:
 ...
 ![IoT Architecture Diagram](/images/templates/cognitiveservicesarchitecture.png)
