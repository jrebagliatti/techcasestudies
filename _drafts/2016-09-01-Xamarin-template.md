...
- Solution overview 
- Key technologies used (such as Azure Services, Visual Studio Team Services, Team Foundation Server, HockeyApp, Xamarin Test Cloud) 
...
This section will define the problem(s)/challenges that the customer wants to address with a Xamarin mobile application solution. Include things like costs, customer experience, and so on.
