...
When building and collaborating on the project, we leveraged mock services and mock data as different layers of the solution were being developed. Working in parallel and simulating dependencies allowed us to develop and test faster.
