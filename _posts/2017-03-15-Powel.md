...
As there is too much code to display and explain in this report, please find all the source code for the hackfest in the following [GitHub repository](https://github.com/PowelAS/field-worker-bot).
...
[Link to GitHub repository](https://github.com/PowelAS/field-worker-bot)
