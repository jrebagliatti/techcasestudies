---
layout: post
title:  "Microsoft, Aegex join to protect workers in hazardous industries with IoT app"
author: "Kristin Ottofy, Joe Raio, Blain Barton, Dave Voyles, and Tom Ventulett"
author-link: "#"
author-image: "{{ site.baseurl }}/images/Aegex/teampic-v2.jpg"
date:   2017-06-05
categories: [Azure App Service, Azure Functions, IoT, Mobile Application Development with Xamarin]
color: "blue"
#image: "{{ site.baseurl }}/images/imagename.png" #should be ~350px tall
excerpt: "Microsoft and Aegex Technologies worked together to build a Xamarin app for viewing device data in hazardous work environments."
language: "English"
...
Aegex Technologies provides the first Windows 10 tablet that is globally certified intrinsically safe for use in the most hazardous industrial locations worldwide. The 2-year-old company's mission is to "transform industries by safely connecting every person and every thing that operates in a hazardous location worldwide."
