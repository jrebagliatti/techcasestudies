...
categories: [DevOps]
color: "blue"
image: "images/feat_orckestra2.jpg"
...
<img src="{{ site.baseurl }}/images/orckestra2.jpg" alt="Value Stream Mapping" style="width: 90%;"/>
...
As of today, the application is built following a single value stream. In the future, this stream will be split into  two smaller ones:
